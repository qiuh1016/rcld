    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        case 0:
            ...
            case 2:
                ...
                switchCellSwitch.addTarget(self, action: #selector(userViewController.refreshStaffHistorySetting(_:)), forControlEvents: UIControlEvents.ValueChanged)
        ...
        case 1:
            ...
            case 0:
                ...
                switchCellSwitch.addTarget(self, action: #selector(userViewController.showWalkthroughView(_:)), forControlEvents: UIControlEvents.ValueChanged)
